# forensiczip_hf.py
# FORENSICZIP integration for HuggingFace LLaVA-style models (FakeVLM inference).
# - Training-free token pruning via Lagrangian OT novelty (Sinkhorn).
# - Real pruning: the returned visual patch tokens are actually reduced.
